class AES:
    ...
    def aes_encrypt(self, plaintext_list, RoundKeys):
        # T盒构造
        SBOX = sum(self.S_BOX, [])
        RoundKeyss = [self.ShiftRows(rkey) for rkey in RoundKeys[:-1]] + RoundKeys[-1:]
        TBOX = [[[SBOX[i ^ RoundKeyss[r][ki]] for i in range(0x100)] for ki in range(16)] for r in range(10)]
        ...
        s = self.AddRoundKey(s, RoundKeys, -1)
...
if __name__ == '__main__':
    ...
    # 0xff0b844a0853bf7c6934ab4364148fb9